window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chrisli/Documents/dev/dsh-balance-meter/src/client/BudgetCapsule.module.css.mjs
		const css = ".tVcLea_root{height:32px;color:var(--dsw-alias-label-primary,#e5e7eb);order:-1;align-self:center;align-items:center;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Microsoft YaHei,sans-serif;font-size:12px;line-height:1.5;display:flex;position:relative}.tVcLea_capsule{border:1px solid var(--dsw-alias-border-l2);height:32px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);cursor:pointer;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:8px;padding:6px 12px;font-size:13px;font-weight:400;line-height:20px;display:inline-flex}.tVcLea_capsule:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.tVcLea_bandTag{color:var(--dsw-alias-label-secondary);flex:none;align-items:center;gap:4px;font-size:12px;line-height:20px;display:inline-flex}.tVcLea_bandTag[data-peak]{color:#f59e0b}.tVcLea_bandDot{background:var(--dsw-alias-state-success-primary,#34d399);border-radius:50%;flex:none;width:6px;height:6px}.tVcLea_bandDot[data-peak]{background:#f59e0b}.tVcLea_text{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary);white-space:nowrap;flex:none;font-size:12px;font-weight:500}.tVcLea_backdrop{z-index:90;position:fixed;inset:0}.tVcLea_card{z-index:100;background:var(--dsw-alias-bg-layer-1,#171a21);border:1px solid var(--dsw-alias-border-l1,#27272a);border-radius:12px;flex-direction:column;gap:6px;width:268px;padding:12px;display:flex;position:absolute;top:calc(100% + 6px);right:0;box-shadow:0 8px 24px #00000059}.tVcLea_cardHead{align-items:center;gap:8px;display:flex}.tVcLea_cardTitle{flex:1;font-size:13px;font-weight:600}.tVcLea_band{color:var(--dsw-alias-label-secondary,#a1a1aa);align-items:center;gap:8px;font-size:11px;display:inline-flex}.tVcLea_bandLabel{color:inherit;align-items:center;gap:4px;display:inline-flex}.tVcLea_bandLabel[data-peak]{color:#f59e0b}.tVcLea_iconButton{color:var(--dsw-alias-label-secondary,#a1a1aa);cursor:pointer;background:0 0;border:0;flex:none;padding:2px 4px;font-size:12px}.tVcLea_balanceSection{border-bottom:1px solid var(--dsw-alias-border-l1,#27272a);flex-direction:column;gap:5px;margin:2px 0 4px;padding-bottom:8px;display:flex}.tVcLea_balanceTotal{align-items:flex-end;gap:8px;display:flex}.tVcLea_balanceTotalLabel{color:var(--dsw-alias-label-secondary,#a1a1aa);font-size:11px}.tVcLea_balanceTotalValue{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary,#e5e7eb);flex:1;font-size:24px;font-weight:700;line-height:1.2}.tVcLea_topUp{border:1px solid var(--dsw-alias-border-l2,#3f3f46);background:var(--dsw-alias-bg-layer-2,#262b36);color:var(--dsw-alias-brand-primary,#4d6bfe);cursor:pointer;border-radius:6px;flex:none;padding:3px 10px;font-size:11px;text-decoration:none}.tVcLea_refreshButton{border:1px solid var(--dsw-alias-border-l2,#3f3f46);background:var(--dsw-alias-bg-layer-2,#262b36);width:22px;height:22px;color:var(--dsw-alias-label-secondary,#a1a1aa);cursor:pointer;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:14px;line-height:1;display:inline-flex}.tVcLea_refreshButton:hover:not(:disabled){color:var(--dsw-alias-label-primary,#e5e7eb);background:var(--dsw-alias-interactive-bg-hover,#33363e)}.tVcLea_refreshButton:disabled{opacity:.55;cursor:default}.tVcLea_topUp:hover{background:var(--dsw-alias-interactive-bg-hover,#33363e)}.tVcLea_spendStats{border-bottom:1px solid var(--dsw-alias-border-l1,#27272a);flex-direction:column;gap:6px;padding-bottom:8px;display:flex}.tVcLea_row{color:var(--dsw-alias-label-secondary,#a1a1aa);justify-content:space-between;gap:8px;display:flex}.tVcLea_row>span:last-child{color:var(--dsw-alias-label-primary,#e5e7eb);font-variant-numeric:tabular-nums}.tVcLea_section{text-transform:uppercase;letter-spacing:.04em;color:var(--dsw-alias-label-secondary,#a1a1aa);margin-top:6px;font-size:11px}.tVcLea_settingsBlock{border-top:1px solid var(--dsw-alias-border-l1,#27272a);margin-top:8px;padding-top:8px}.tVcLea_field{color:var(--dsw-alias-label-secondary,#a1a1aa);justify-content:space-between;align-items:center;gap:8px;display:flex}.tVcLea_field input[type=number],.tVcLea_field select{border:1px solid var(--dsw-alias-border-l1,#27272a);background:var(--dsw-alias-bg-layer-2,#262b36);width:108px;color:var(--dsw-alias-label-primary,#e5e7eb);border-radius:6px;padding:3px 6px;font-size:12px}.tVcLea_toast{background:var(--dsw-alias-bg-layer-1,#171a21);border:1px solid var(--dsw-alias-border-l1,#27272a);border-radius:10px;align-items:center;gap:8px;max-width:300px;padding:8px 12px;display:flex;position:absolute;bottom:calc(100% + 6px);right:0;box-shadow:0 8px 24px #00000059}.tVcLea_toastText{flex:1}.tVcLea_toast[data-level=warn]{border-color:#f59e0b}.tVcLea_toast[data-level=error]{border-color:var(--dsw-alias-state-error-primary,#f87171)}";
		...
		var BudgetCapsule_module_css_default = {
			"cardTitle": "tVcLea_cardTitle",
			"field": "tVcLea_field",
			"topUp": "tVcLea_topUp",
			"refreshButton": "tVcLea_refreshButton",
			"capsule": "tVcLea_capsule",
			"toastText": "tVcLea_toastText",
			"bandTag": "tVcLea_bandTag",
			"row": "tVcLea_row",
			"settingsBlock": "tVcLea_settingsBlock",
			"bandDot": "tVcLea_bandDot",
			"card": "tVcLea_card",
			"text": "tVcLea_text",
			"cardHead": "tVcLea_cardHead",
			"bandLabel": "tVcLea_bandLabel",
			"balanceSection": "tVcLea_balanceSection",
			"band": "tVcLea_band",
			"balanceTotalLabel": "tVcLea_balanceTotalLabel",
			"balanceTotalValue": "tVcLea_balanceTotalValue",
			"section": "tVcLea_section",
			"backdrop": "tVcLea_backdrop",
			"toast": "tVcLea_toast",
			"spendStats": "tVcLea_spendStats",
			"balanceTotal": "tVcLea_balanceTotal",
			"iconButton": "tVcLea_iconButton",
			"root": "tVcLea_root"
		};
		//#endregion
