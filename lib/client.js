window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = "._5iDdYG_root{color:var(--dsw-alias-label-primary,#e5e7eb);flex-direction:column;order:-1;align-items:flex-end;gap:8px;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Microsoft YaHei,sans-serif;font-size:12px;line-height:1.5;display:inline-flex;position:relative}._5iDdYG_capsule{border:1px solid var(--dsw-alias-border-l2);height:32px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);cursor:pointer;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:6px;padding:6px 12px;font-size:13px;font-weight:400;line-height:20px;display:inline-flex}._5iDdYG_capsule:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}._5iDdYG_bandTag{color:var(--dsw-alias-label-secondary);flex:none;align-items:center;gap:4px;font-size:12px;line-height:20px;display:inline-flex}._5iDdYG_bandTag[data-peak]{color:#f59e0b}._5iDdYG_bandDot{background:var(--dsw-alias-state-success-primary,#34d399);border-radius:50%;flex:none;width:6px;height:6px}._5iDdYG_bandDot[data-peak]{background:#f59e0b}._5iDdYG_text{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary);white-space:nowrap;flex:none;font-weight:500}._5iDdYG_spin{border:2px solid var(--dsw-alias-border-l2,#3f3f46);border-top-color:var(--dsw-alias-label-tertiary,#71717a);border-radius:50%;flex:none;width:10px;height:10px;animation:.8s linear infinite _5iDdYG_budgetSpin}@keyframes _5iDdYG_budgetSpin{to{transform:rotate(360deg)}}._5iDdYG_backdrop{z-index:90;position:fixed;inset:0}._5iDdYG_card{z-index:100;background:var(--dsw-alias-bg-layer-1,#171a21);border:1px solid var(--dsw-alias-border-l1,#27272a);border-radius:12px;flex-direction:column;gap:6px;width:268px;padding:12px;display:flex;position:absolute;top:calc(100% + 6px);right:0;box-shadow:0 8px 24px #00000059}._5iDdYG_cardHead{align-items:center;gap:8px;display:flex}._5iDdYG_cardTitle{flex:1;font-size:13px;font-weight:600}._5iDdYG_band{color:var(--dsw-alias-label-secondary,#a1a1aa);align-items:center;font-size:11px;display:inline-flex}._5iDdYG_bandLabel{color:inherit;align-items:center;gap:4px;display:inline-flex}._5iDdYG_bandLabel[data-peak]{color:#f59e0b}._5iDdYG_iconButton{color:var(--dsw-alias-label-secondary,#a1a1aa);cursor:pointer;background:0 0;border:0;flex:none;padding:2px 4px;font-size:12px}._5iDdYG_balanceSection{border-bottom:1px solid var(--dsw-alias-border-l1,#27272a);flex-direction:column;gap:5px;margin:2px 0 4px;padding-bottom:8px;display:flex}._5iDdYG_balanceTotal{align-items:flex-end;gap:8px;display:flex}._5iDdYG_balanceTotalLabel{color:var(--dsw-alias-label-secondary,#a1a1aa);font-size:11px}._5iDdYG_balanceTotalValue{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary,#e5e7eb);flex:1;font-size:24px;font-weight:700;line-height:1.2}._5iDdYG_topUp{border:1px solid var(--dsw-alias-border-l2,#3f3f46);background:var(--dsw-alias-bg-layer-2,#262b36);color:var(--dsw-alias-brand-primary,#4d6bfe);cursor:pointer;border-radius:6px;flex:none;padding:3px 10px;font-size:11px;text-decoration:none}._5iDdYG_topUp:hover{background:var(--dsw-alias-interactive-bg-hover,#33363e)}._5iDdYG_row{color:var(--dsw-alias-label-secondary,#a1a1aa);justify-content:space-between;gap:8px;display:flex}._5iDdYG_row>span:last-child{color:var(--dsw-alias-label-primary,#e5e7eb);font-variant-numeric:tabular-nums}._5iDdYG_section{text-transform:uppercase;letter-spacing:.04em;color:var(--dsw-alias-label-secondary,#a1a1aa);margin-top:6px;font-size:11px}._5iDdYG_settingsBlock{border-top:1px solid var(--dsw-alias-border-l1,#27272a);margin-top:8px;padding-top:8px}._5iDdYG_field{color:var(--dsw-alias-label-secondary,#a1a1aa);justify-content:space-between;align-items:center;gap:8px;display:flex}._5iDdYG_field input[type=number],._5iDdYG_field select{border:1px solid var(--dsw-alias-border-l1,#27272a);background:var(--dsw-alias-bg-layer-2,#262b36);width:108px;color:var(--dsw-alias-label-primary,#e5e7eb);border-radius:6px;padding:3px 6px;font-size:12px}._5iDdYG_toast{background:var(--dsw-alias-bg-layer-1,#171a21);border:1px solid var(--dsw-alias-border-l1,#27272a);border-radius:10px;align-items:center;gap:8px;max-width:300px;padding:8px 12px;display:flex;box-shadow:0 8px 24px #00000059}._5iDdYG_toastText{flex:1}._5iDdYG_toast[data-level=warn]{border-color:#f59e0b}._5iDdYG_toast[data-level=error]{border-color:var(--dsw-alias-state-error-primary,#f87171)}";
