window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const en = {
			...
			"card.refresh": "Refresh balance",
			"card.refreshTitle": "Refresh balance manually",
			...
			"settings.bandTimes": "Peak / off-peak windows",
		...
		*/
		...
		const ledger = new LedgerStore(() => parseLedgerPayload(readJsonWithLegacy(LEDGER_KEY, LEGACY_LEDGER_KEY)), (records) => writeJson(LEDGER_KEY, records));
		...
		//#endregion
		//#region \0dsh-css:/Users/chrisli/Documents/dev/dsh-balance-tracker/src/client/BudgetCapsule.module.css.mjs
		const css = ".t5UWrq_root{height:32px;color:var(--dsw-alias-label-primary,#e5e7eb);order:-1;align-self:center;align-items:center;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,PingFang SC,Microsoft YaHei,sans-serif;font-size:12px;line-height:1.5;display:flex;position:relative}.t5UWrq_capsule{border:1px solid var(--dsw-alias-border-l2);height:32px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);cursor:pointer;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:8px;padding:6px 12px;font-size:13px;font-weight:400;line-height:20px;display:inline-flex}.t5UWrq_capsule:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.t5UWrq_bandTag{color:var(--dsw-alias-label-secondary);flex:none;align-items:center;gap:4px;font-size:12px;line-height:20px;display:inline-flex}.t5UWrq_bandTag[data-peak]{color:#f59e0b}.t5UWrq_bandDot{background:var(--dsw-alias-state-success-primary,#34d399);border-radius:50%;flex:none;width:6px;height:6px}.t5UWrq_bandDot[data-peak]{background:#f59e0b}.t5UWrq_text{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary);white-space:nowrap;flex:none;font-size:12px;font-weight:500}.t5UWrq_backdrop{z-index:90;position:fixed;inset:0}.t5UWrq_card{z-index:100;background:var(--dsw-alias-bg-layer-1,#171a21);border:1px solid var(--dsw-alias-border-l1,#27272a);border-radius:12px;flex-direction:column;gap:6px;width:268px;padding:12px;display:flex;position:absolute;top:calc(100% + 6px);right:0;box-shadow:0 8px 24px #00000059}.t5UWrq_cardHead{align-items:center;gap:8px;display:flex}.t5UWrq_cardTitle{flex:1;font-size:13px;font-weight:600}.t5UWrq_band{color:var(--dsw-alias-label-secondary,#a1a1aa);align-items:center;gap:8px;font-size:11px;display:inline-flex}.t5UWrq_bandLabel{color:inherit;align-items:center;gap:4px;display:inline-flex}.t5UWrq_bandLabel[data-peak]{color:#f59e0b}.t5UWrq_iconButton{color:var(--dsw-alias-label-secondary,#a1a1aa);cursor:pointer;background:0 0;border:0;flex:none;padding:2px 4px;font-size:12px}.t5UWrq_balanceSection{border-bottom:1px solid var(--dsw-alias-border-l1,#27272a);flex-direction:column;gap:5px;margin:2px 0 4px;padding-bottom:8px;display:flex}.t5UWrq_balanceTotal{align-items:flex-end;gap:8px;display:flex}.t5UWrq_balanceTotalLabel{color:var(--dsw-alias-label-secondary,#a1a1aa);font-size:11px}.t5UWrq_balanceTotalValue{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary,#e5e7eb);flex:1;font-size:24px;font-weight:700;line-height:1.2}.t5UWrq_topUp{border:1px solid var(--dsw-alias-border-l2,#3f3f46);background:var(--dsw-alias-bg-layer-2,#262b36);color:var(--dsw-alias-brand-primary,#4d6bfe);cursor:pointer;border-radius:6px;flex:none;padding:3px 10px;font-size:11px;text-decoration:none}.t5UWrq_refreshButton{border:1px solid var(--dsw-alias-border-l2,#3f3f46);background:var(--dsw-alias-bg-layer-2,#262b36);width:22px;height:22px;color:var(--dsw-alias-label-secondary,#a1a1aa);cursor:pointer;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:14px;line-height:1;display:inline-flex}.t5UWrq_refreshButton:hover:not(:disabled){color:var(--dsw-alias-label-primary,#e5e7eb);background:var(--dsw-alias-interactive-bg-hover,#33363e)}.t5UWrq_refreshButton:disabled{opacity:.55;cursor:default}.t5UWrq_topUp:hover{background:var(--dsw-alias-interactive-bg-hover,#33363e)}.t5UWrq_spendStats{border-bottom:1px solid var(--dsw-alias-border-l1,#27272a);flex-direction:column;gap:6px;padding-bottom:8px;display:flex}.t5UWrq_row{color:var(--dsw-alias-label-secondary,#a1a1aa);justify-content:space-between;gap:8px;display:flex}.t5UWrq_row>span:first-child{white-space:nowrap;flex:none}.t5UWrq_row>span:last-child{color:var(--dsw-alias-label-primary,#e5e7eb);font-variant-numeric:tabular-nums;text-align:right;white-space:normal;overflow-wrap:break-word;flex:auto}.t5UWrq_section{text-transform:uppercase;letter-spacing:.04em;color:var(--dsw-alias-label-secondary,#a1a1aa);margin-top:6px;font-size:11px}.t5UWrq_settingsBlock>.t5UWrq_section{margin-top:0}.t5UWrq_settingsBlock,.t5UWrq_bandBlock{border-top:1px solid var(--dsw-alias-border-l1,#27272a);flex-direction:column;gap:6px;margin-top:8px;padding-top:8px;display:flex}.t5UWrq_field{color:var(--dsw-alias-label-secondary,#a1a1aa);justify-content:space-between;align-items:center;gap:8px;display:flex}.t5UWrq_field input[type=number],.t5UWrq_field select{border:1px solid var(--dsw-alias-border-l1,#27272a);background:var(--dsw-alias-bg-layer-2,#262b36);width:108px;color:var(--dsw-alias-label-primary,#e5e7eb);border-radius:6px;padding:3px 6px;font-size:12px}.t5UWrq_toast{background:var(--dsw-alias-bg-layer-1,#171a21);border:1px solid var(--dsw-alias-border-l1,#27272a);border-radius:10px;align-items:center;gap:8px;max-width:300px;padding:8px 12px;display:flex;position:absolute;bottom:calc(100% + 6px);right:0;box-shadow:0 8px 24px #00000059}.t5UWrq_toastText{flex:1}.t5UWrq_toast[data-level=warn]{border-color:#f59e0b}.t5UWrq_toast[data-level=error]{border-color:var(--dsw-alias-state-error-primary,#f87171)}";
		const tagId = "dsh-balance-tracker/BudgetCapsule.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-balance-tracker";
		...
		var BudgetCapsule_module_css_default = {
			"field": "t5UWrq_field",
			"bandLabel": "t5UWrq_bandLabel",
			"iconButton": "t5UWrq_iconButton",
			"topUp": "t5UWrq_topUp",
			"bandBlock": "t5UWrq_bandBlock",
			"toast": "t5UWrq_toast",
			"bandTag": "t5UWrq_bandTag",
			"cardTitle": "t5UWrq_cardTitle",
			"backdrop": "t5UWrq_backdrop",
			"toastText": "t5UWrq_toastText",
			"balanceTotal": "t5UWrq_balanceTotal",
			"settingsBlock": "t5UWrq_settingsBlock",
			"cardHead": "t5UWrq_cardHead",
			"card": "t5UWrq_card",
			"capsule": "t5UWrq_capsule",
			"band": "t5UWrq_band",
			"row": "t5UWrq_row",
			"root": "t5UWrq_root",
			"text": "t5UWrq_text",
			"bandDot": "t5UWrq_bandDot",
			"refreshButton": "t5UWrq_refreshButton",
			"balanceTotalLabel": "t5UWrq_balanceTotalLabel",
			"balanceTotalValue": "t5UWrq_balanceTotalValue",
			"balanceSection": "t5UWrq_balanceSection",
			"spendStats": "t5UWrq_spendStats",
			"section": "t5UWrq_section"
		};
		//#endregion
						...
						children: [
								...
								children: [
									(0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											(0, react_jsx_runtime.jsx)("button", {
												type: "button",
												className: BudgetCapsule_module_css_default.refreshButton,
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsxs)("div", {
										className: BudgetCapsule_module_css_default.bandBlock,
										children: [
											(0, react_jsx_runtime.jsx)("div", {
												className: BudgetCapsule_module_css_default.section,
												children: t("settings.bandTimes")
											}),
											(0, react_jsx_runtime.jsxs)("div", {
												className: BudgetCapsule_module_css_default.row,
												children: [(0, react_jsx_runtime.jsx)("span", { children: t("card.peak") }), (0, react_jsx_runtime.jsx)("span", { children: formatWindows(parsePeakWindows(settings.peakWindows)) })]
											}),
											(0, react_jsx_runtime.jsxs)("div", {
												className: BudgetCapsule_module_css_default.row,
												children: [(0, react_jsx_runtime.jsx)("span", { children: t("card.off") }), (0, react_jsx_runtime.jsx)("span", { children: formatWindows(offPeakWindows(parsePeakWindows(settings.peakWindows))) })]
											})
										]
									})
								]
		...
		*/
		...
		function apply(ctx, config) {
			...
			ctx.effect(() => ctx.locale.register(NS, {
				zh,
				en
			}), "dsh-balance-tracker: dictionaries");
