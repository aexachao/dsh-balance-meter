...
import { formatWindows, isPeak, offPeakWindows, parsePeakWindows } from "./pricing.js";
...
export function BudgetCapsule({ t }) {
    ...
    return (_jsxs("div", { className: css.root, children: [toast && (_jsx("div", { className: css.toast, "data-level": "warn", role: "alert", children: _jsx("span", { className: css.toastText, children: t('toast.warn', { spent: formatYuan(totals.cost), warn: formatYuan(settings.warnYuan) }) }) })), view && !view.ok && !balanceDismissed && (_jsxs("div", { className: css.toast, "data-level": "error", role: "alert", children: [_jsx("span", { className: css.toastText, children: view.error ?? t('card.balanceError') }), _jsx("button", { type: "button", className: css.iconButton, "aria-label": t('toast.close'), onClick: () => { setBalanceDismissed(true); }, children: "\u2715" })] })), expanded && (_jsxs(_Fragment, { children: [_jsx("div", { className: css.backdrop, onClick: () => setExpanded(false) }), _jsxs("div", { className: css.card, children: [_jsxs("div", { className: css.cardHead, children: [_jsx("span", { className: css.cardTitle, children: t('card.title') }), _jsxs("span", { className: css.band, children: [`${t('card.peakNow')}:`, _jsxs("span", { className: css.bandLabel, "data-peak": peakNow || undefined, children: [_jsx("span", { className: css.bandDot, "data-peak": peakNow || undefined }), peakNow ? t('card.peak') : t('card.off')] })] })] }), balance && (_jsxs("div", { className: css.balanceSection, children: [_jsxs("div", { className: css.balanceTotal, children: [_jsx("span", { className: css.balanceTotalLabel, children: t('card.totalBalance') }), _jsx("span", { className: css.balanceTotalValue, children: formatYuanText(balance.totalBalance) }), _jsx("button", { type: "button", className: css.refreshButton, "aria-label": t('card.refresh'), title: t('card.refreshTitle'), disabled: loading, onClick: () => { void refresh(); }, children: "\u21BB" }), _jsx("a", { className: css.topUp, href: TOP_UP_URL, target: "_blank", rel: "noreferrer", title: t('card.topUpTitle'), children: t('card.topUp') })] }), _jsxs("div", { className: css.row, children: [_jsx("span", { children: t('card.grantedBalance') }), _jsx("span", { children: formatYuanText(balance.grantedBalance) })] }), _jsxs("div", { className: css.row, children: [_jsx("span", { children: t('card.toppedUpBalance') }), _jsx("span", { children: formatYuanText(balance.toppedUpBalance) })] })] })), (view?.todayConsumed !== undefined || view?.totalConsumed !== undefined) && (_jsxs("div", { className: css.spendStats, children: [_jsxs("div", { className: css.row, children: [_jsx("span", { children: t('card.spent') }), _jsx("span", { children: view?.todayConsumed !== undefined
                                                ...
                                                } }, `warn-${settings.warnYuan}`)] }), _jsxs("label", { className: css.field, children: [_jsx("span", { children: t('settings.stopOnOver') }), _jsx("input", { type: "checkbox", checked: settings.stopOnOver, onChange: (event) => updateSettings({ stopOnOver: event.target.checked }) })] }), _jsxs("div", { className: css.bandBlock, children: [_jsx("div", { className: css.section, children: t('settings.bandTimes') }), _jsxs("div", { className: css.row, children: [_jsx("span", { children: t('card.peak') }), _jsx("span", { children: formatWindows(parsePeakWindows(settings.peakWindows)) })] }), _jsxs("div", { className: css.row, children: [_jsx("span", { children: t('card.off') }), _jsx("span", { children: formatWindows(offPeakWindows(parsePeakWindows(settings.peakWindows))) })] })] })] })] })] })), _jsxs("button", { type: "button", className: css.capsule, title: t('capsule.title'), "aria-label": t('capsule.label'), "aria-expanded": expanded, onClick: () => setExpanded((value) => !value), children: [_jsxs("span", { className: css.bandTag, "data-peak": peakNow || undefined, children: [_jsx("span", { className: css.bandDot, "data-peak": peakNow || undefined }), peakNow ? t('card.peak') : t('card.off')] }), _jsx("span", { className: css.text, children: balance ? formatYuanText(balance.totalBalance) : '¥--' })] })] }));
}
