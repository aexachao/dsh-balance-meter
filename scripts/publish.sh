...
# file. Keep it out of shell history by exporting it. Accounts with 2FA
# "auth and writes" must pass NPM_OTP (or use an Automation token, which
# bypasses the one-time password).
set -euo pipefail
